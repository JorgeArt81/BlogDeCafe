...
<div class="course">
    <div class="course-img">
        <img src="{{ asset('storage/img/curso1.jpg') }}" alt="Imagen de curso">
    </div>
    <div class="course-info">
        <h5 class="course-info__title">Técnicas de Extracción de Café</h5>
        <p class="course-info__label">Precio:
            <span class="course-info__value">Gratuito</span>
        </p>
        <p class="course-info__label">Cupo:
            <span class="course-info__value">20</span>
        </p>
        ...
        <x-link class="btn-link brown">{{ __('Sobre el Curso') }}</x-link>
    </div>
</div>
{{-- end course --}}
<div class="course">
    <div class="course-img">
        <img src="{{ asset('storage/img/curso2.jpg') }}" alt="Imagen de curso">
    </div>
    <div class="course-info">
        <h5 class="course-info__title">Taller para Tostar y Moler Granos</h5>
        <p class="course-info__label">Precio:
            <span class="course-info__value">Gratuito</span>
        </p>
        <p class="course-info__label">Cupo:
...
<div class="course">
    <div class="course-img">
        <img src="{{ asset('storage/img/curso3.jpg') }}" alt="Imagen de curso">
    </div>
    <div class="course-info">
        <h5 class="course-info__title">4 Recetas de Café para principiantes</h5>
        <p class="course-info__label">Precio:
            <span class="course-info__value">Gratuito</span>
        </p>
        <p class="course-info__label">Cupo:
